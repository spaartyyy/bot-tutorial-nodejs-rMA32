...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexP = /^\/PDL/i;  botRegexTw = /^\/twitch/i; botRegexSb = /^\/sub/; botRegexSh = /^\/shrug/; botRegexDe = /^\/whats derek like/; botRegexWk = /^\/users/;
  ...
  else if(request.text && botRegexDe.test(request.text)) {
    this.res.writeHead(200);
    postMessage("hes gay");
    this.res.end();
